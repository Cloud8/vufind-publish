...
/**
 * @title Dpub Admin and Metadata processing 
    ...
    implements \VuFind\I18n\Translator\TranslatorAwareInterface
{
    ...
    public function __construct($name = null, $options = [])
    {
        ...
        $this->db = $options['db'];
        $this->autobib = $options['autobib'];
        $this->domain = $options['domain'];
    }

    // see themes/seaview/templates/dpub/admin.phtml
    public function create($post = []) {
        ...
        if (isset($post['opus:ppn'])) {
            ...
            $this->page = 1;
            DpubAdmin::rest($this->autobib, 'ppn', $post['opus:ppn']);
        }

        if ($this->page=='1') { // submissions : temp table records
            // $this->title = 'Dpub::Submissions';
            $this->table = 'temp:';
            $query = 'SELECT '
            ...
            $this->data = [
                ['id' => '1', 'url' => '?page=3', 
                 'label' => 'Dpub::Records', 'text' => 'Dpub::No PID'], 
                ['id' => '2', 'label' => 'PPN', 'text' => 'Dpub::Create'],
                ['id' => '3', 'url' => '?page=4', 
                 'label' => 'Dpub::Records', 'text' => 'Dpub::Deleted'], 
            ...
            // error_log("DpubAdmin series create ".$this->page." # ".$sid);
            $this->title = 'Serial';
            ...
            // error_log("DpubAdmin collection create ".$this->page);
            $this->title = 'Collection';
    ...
    public function process($post = []) {
        ...
        if ($this->page==6 && empty($sid) && empty($series)) {
            ...
            if ($action=='delete') {
                ...
                DpubAdmin::rest($this->autobib, $action, 's'.$sid);
            } else {
            ...
            if (empty($url)) {
                ...
                $urn = DpubAdmin::rest($this->autobib, 'urn', $raw);
            ...
            if ($action=='delete') {
                ...
                DpubAdmin::rest($this->autobib, $action, 'c'.$cid);
            } else {
