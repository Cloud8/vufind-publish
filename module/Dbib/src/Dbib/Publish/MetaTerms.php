...
class MetaTerms {
    ...
    private function createTerms() {
        $this->terms = [
            ...
            ['opus:file', 'Dbib::Files', 'file', 1, true, null],
            ['opus:filecount', 'Dbib::filecount', 'number', 1, false, null],
            // ['Dbib::filesubmit', 'files', 'ref']], // see metadata.phtml

            ['dcterms:title', 'Title', 'area', 2, true,
             'Dbib::Original title of work', null],
            ['dcterms:alternative', 'Transliterated Title', 'area', 2, false,
             'Dbib::Transliterated title of work', null],
            ['separator', '<hr><br>', 'separator', 2, false],
            // array of authors / authorids
            ['dcterms:creator', 'CreatorRoles::aut', 'text', 2, true,
              ['Dbib::Last Name, First Name' , 'opus:authorid', 'ref3']],
            ['opus:authorid', 'Dbib::AuthorId', 'text2', 2, false, 
             ['Dbib::AuthorId', 'authorid', 'ref']],
            ['opus:advisor', 'CreatorRoles::dgs', 'text', 2, false,
              'Dbib::Last Name, First Name (Title)'],
            ...
            ['dcterms:dateAccepted', 'Accepted', 'date', 2, false,
             'Dbib::Date accepted'],
            ['opus:isbn', 'ISBN / ISSN', 'text', 2, false, 'Dbib::ISBN', null],
            ['dcterms:source', 'Source', 'text', 2, false,'Dbib::Other Source'],
            ...
            ['opus:box', 'Dbib::Permissions', 'checkbox', 3, true,
             ['Dbib::accept', 'license', 'ref']],
            ['opus:dsgvo', 'Dbib::DSGVO', 'checkbox', 3, true,
             ['Dbib::DSGVO', 'dsgvo', 'ref']],
            ['opus:msg', 
        ...
        for($k=0; $k<count($this->terms); ++$k) {
            if ($this->terms[$k][0]=='dcterms:type' && !empty($umail)) {
                ...
                if (isset($data['delete'])) {
                    $this->terms[$k][1] = 'Dbib::Data deleted';
                } else {
                    $this->terms[$k][1] = 'Dbib::Data saved';
                }
